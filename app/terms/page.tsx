export default function Terms() {
  return (
    <main className="max-w-5xl mx-auto px-8 lg:px-0 font-serif text-text-secondary [&>h2]:text-2xl [&>h2]:font-sans [&>h2]:text-cyan-700 [&>h2]:dark:text-cyan-300 [&>h2]:mt-4 [&>h3]:text-xl [&>h3]:font-sans [&>h3]:text-lime-700 [&>h3]:dark:text-lime-300 [&>h3]:mt-2">
      <h1 className="text-4xl font-sans text-indigo-700 dark:text-indigo-300">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Mockup.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Mockup, accessible from{" "}
            <a
              href="mockup.dsingh.dev"
        ...
        <li>
          <p>
            ...
            <a
              ...
              target="_blank"
            >
              https://mockup.dsingh.dev/contact
            </a>
          </p>
        </li>
      </ul>
